            ...
            {followingUsers.length > 0 ? (
              <div className="space-y-6">
                {followingUsers.map((followedUser) => (
                  <div key={followedUser.id} className="space-y-4">
                    {/* User Header */}
              ...
              <div className="text-center py-12 px-4 rounded-xl border-2 border-dashed">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-1">Not Following Anyone Yet</h3>
                <p className="text-gray-600 mb-4">Start following other travelers to see their itineraries here</p>
